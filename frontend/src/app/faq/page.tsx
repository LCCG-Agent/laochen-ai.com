  ...
  const faqCategories = [
    {
      ...
      questions: [
        {
          q: "什么是老陈AI工坊？",
          a: "老陈AI工坊是一个专注数据分析自动化的平台。我们提供体系框架（道）、工具清单（术）、下载模板（器）三位一体的解决方案，帮助你用一句话完成数据分析任务。",
        },
        {
          q: "我需要有编程基础吗？",
    ...
    },
    {
      ...
      questions: [
        ...
        {
          q: "可以自定义模板吗？",
          a: "可以！每个模板都支持一定程度的自定义。你可以修改输出格式、调整分析逻辑、添加自己的指令等。详细的自定义教程请查看「术」栏目中的相关文章。",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      questions: [
        {
          q: "道/术/器是什么意思？",
          a: "这是我们对数据分析自动化能力的分层：\n- 道：方法论和体系框架，帮你建立正确的思维方式\n- 术：具体的工具和技巧，可以直接拿来使用\n- 器：现成的模板，开箱即用\n\n三者相辅相成，从\"道\"到\"器\"逐步落地。",
        },
        {
          q: "应该从哪里开始学习？",
          a: "推荐的学习路径：\n1. 先下载一个模板体验一下自动化的感觉\n2. 阅读\"道\"栏目的体系框架文章，建立整体认知\n3. 根据需要学习\"术\"栏目中的具体工具\n4. 逐步扩展使用更多模板\n\n详细的学习路线请查看\"道\"栏目中的\"推荐学习路线\"部分。",
        },
        {
          q: "如何建立自己的数据分析自动化体系？",
          a: "核心是6个模块：\n1. 目标：明确你要交付什么\n2. 数据源：确定数据从哪来\n3. 标准化：统一字段和口径\n4. 自动化流程：搭建处理链路\n5. 质量控制：建立检查机制\n6. 复用资产：沉淀模板和经验\n\n详细内容请查看\"道\"栏目的\"数分自动化体系地图\"。",
        },
      ],
    },
    {
